...
img.onload=function(){
  context.drawImage(img, 0, 0,default_width*1.8,default_height*1.8);
}
...
function onScroll(){
  ...
  if (frameIndex !== lastFrameIndex) {
     canvas.style.setProperty("transform", `translateY(-${ (1-scrollFraction)*120 }px) scale(${ 1-scrollFraction*0.65 })`);
